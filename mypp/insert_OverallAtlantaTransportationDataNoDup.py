...
fp = open("V:\DVA\DVA Project\DVAProject\data\AtlantaPlacesData\AllIntegratedFiles\OverallAtlantaTransportationDataNoDup.xml","r")
element = ET.parse(fp)
...
for i in y:
    ...
    ca = CityTransportationData(name,vicinity,location_lat,location_lng,icon,id,place_id)
    #print icon
    ca.save()
    print '--------------------------------'