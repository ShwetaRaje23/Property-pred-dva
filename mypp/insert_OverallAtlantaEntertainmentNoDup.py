...
fp = open("V:\DVA\DVA Project\DVAProject\data\AtlantaPlacesData\AllIntegratedFiles\OverallAtlantaEntertainmentNoDup.xml","r")
element = ET.parse(fp)
...
for i in y:
    ...
    ca = CityEntertainment(name,vicinity,location_lat,location_lng,icon,id,place_id)
    #print icon
    ca.save()
    print '--------------------------------'