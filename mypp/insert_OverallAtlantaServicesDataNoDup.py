...
fp = open("V:\DVA\DVA Project\DVAProject\data\AtlantaPlacesData\AllIntegratedFiles\OverallAtlantaServicesDataNoDup.xml","r")
element = ET.parse(fp)
...
for i in y:
    ...
    ca = CityServicesData(name,vicinity,location_lat,location_lng,icon,id,place_id)
    #print icon
    ca.save()
    print '--------------------------------'